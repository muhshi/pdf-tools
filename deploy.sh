...
SECURITY_OAUTH2_REDIRECTURI={baseUrl}/auth/sipetra/callback
...
case "$ACTION" in
    ...
    deploy|*)
        ...
        echo -e "${BLUE}[INFO] Building custom PDF Tools image with Sipetra SSO support...${NC}"
...
echo -e "${YELLOW}bash deploy.sh --logs${NC}"
echo -e "${BLUE}====================================================${NC}"
